...
conf t
 ...
 int gi0/1
  ...
  exit
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.22.22.1 120
 enable secret pass
 line vty 0 14
  password pass
  transport input all
...
conf t
 int fa0/0
  ...
  exit
 ip routing
 ip route 0.0.0.0 0.0.0.0 10.22.100.4 120
 enable secret pass
 line vty 0 14
  password pass
  transport input all
...
conf t
 int gi 0/0/0
  ...
  exit
 ip routing
 ip route 10.22.0.0 255.255.0.0 10.22.22.4 120
 enable secret pass
 line vty 0 14
  password pass
  transport input all
...
| Description                      | Command                                  |
| ---                              | ---                                      |
| a non-default hostname           | hostname coreBaba22                  |
...
~~~
!@NetOps
ansible-playbook -i rivan_mkt.ini playbooks/deploy_22.yml --skip-tags ivrs
~~~
...
conf t
 ...
 crypto pki trustpoint CCNPTRUST
  ...
  subject-alt-name e1.ccnp22.com
...
conf t
 ...
 crypto pki trustpoint CCNPTRUST
  ...
  subject-alt-name e2.ccnp22.com
  revocation-check none
  source interface e3/0
  rsakeypair CERTKEY
  vrf MANAGEMENT
...
conf t
 ...
 crypto pki trustpoint CCNPTRUST
  ...
  subject-alt-name e3.ccnp22.com
  revocation-check none
  source interface e3/0
  rsakeypair CERTKEY
  vrf MANAGEMENT
...
conf t
 ...
 crypto pki trustpoint CCNPTRUST
  ...
  subject-alt-name e4.ccnp22.com
  revocation-check none
  source interface e3/0
  rsakeypair CERTKEY
  vrf MANAGEMENT
...
conf t
 ...
 crypto pki trustpoint CCNPTRUST
  ...
  subject-alt-name e5.ccnp22.com
  revocation-check none
  source interface e3/0
  rsakeypair CERTKEY
  vrf MANAGEMENT
